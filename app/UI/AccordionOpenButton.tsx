...
function AccordionOpenButton({ title, index, isOpen, onClick }: AccordionOpenButtonProps) {
  return (
    <button
      ...
      } flex max-h-12 items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl bg-white hover:bg-gray-100  gap-3`}
