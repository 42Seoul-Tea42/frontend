 ...
 * @param button
 */
const CardForm: React.FC<CardFormProps> = ({ onSubmit, subject, inputs, button, loading }) => {
  return (
    <div className="w-full h-screen flex justify-center bg-green-50">
      <div className="flex flex-col items-center justify-center">
        ...
        {/* loading */}
        {loading && (
          <div className="fixed w-full h-full bg-black opacity-50 flex justify-center items-center">
            <div role="status">
              <svg
                aria-hidden="true"
