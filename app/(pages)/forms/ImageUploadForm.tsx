...
import { addAccountPhotos } from '@/redux/slices/account/accountSlice';
...
export const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>, addPhoto: (e: any) => void) => {
...
export const resizeImage = (base64: string, maxWidth: number, maxHeight: number): Promise<string> => {
  return new Promise<string>((resolve, reject) => {
